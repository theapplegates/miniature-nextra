...
dependencies:
  ...
  eslint-plugin-typescript-sort-keys: 2.1.0_tdm6ms4ntwhlpozn7kjqrhum74
  framer-motion: 7.6.19_biqbaboplfbrettd7655fr4n2y
...
packages:
  ...
  /@typescript-eslint/experimental-utils/5.45.1_s5ps7njkmjlaqajutnox5ntcla:
    resolution: {integrity: sha512-WlXwY9dbmc0Lzu6xQOZ3yN8u/ws/1R8zPC16O217LMZJCbV2hJezqkWMUB+jMwguOJW+cukCDe92vcwwf8zwjQ==}
    engines: {node: ^12.22.0 || ^14.17.0 || >=16.0.0}
    peerDependencies:
  ...
  /framer-motion/7.6.19_biqbaboplfbrettd7655fr4n2y:
    resolution: {integrity: sha512-U+ogwGwNw6Y+pdq6GZB5xvnvLDlq3FTmcKaG5MCUjXuqRLrjKbKTqN4iwZISv3ajwUfgNHM6+tu31LRbYfF9YQ==}
    peerDependencies:
      react: ^18.0.0
      react-dom: ^18.0.0
    dependencies:
